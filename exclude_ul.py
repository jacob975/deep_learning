...
'''
Abstract:
    This is a program to exclude the upper limit happened in band 1 ~ 7 
Usage:
    excluded_ul.py [upper limit table] [data]
...
if __name__ == "__main__":
    ...
    np.savetxt("{0}_tmp.txt".format(data_name[:-4]), data_no_ul, fmt = '%s')
    #-----------------------------------
    # measure time
